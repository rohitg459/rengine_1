...
urlpatterns = [
    path("history/scan", views.scan_history, name="scan_history"),
    path("history/subscan", views.subscan_history, name="subscan_history"),
    path("scheduled/", views.scheduled_scan_view, name="scheduled_scan_view"),
    path("detail/<int:id>", views.detail_scan, name="detail_scan"),
    path("create_report/<int:id>", views.create_report, name="create_report"),
    path("all/subdomains", views.all_subdomains, name="all_subdomains"),
    path("detail/vuln/<int:id>", views.detail_vuln_scan, name="detail_vuln_scan"),
    path("detail/vuln", views.detail_vuln_scan, name="all_vulns"),
    path("visualise/<int:id>", views.visualise, name="visualise"),
    path("detail/all/endpoint", views.all_endpoints, name="all_endpoints"),
    path("start/<int:domain_id>", views.start_scan_ui, name="start_scan"),
    path("schedule/target/<int:host_id>", views.schedule_scan, name="schedule_scan"),
    path(
    ...
    path("start/multiple/", views.start_multiple_scan, name="start_multiple_scan"),
    path(
    ...
    path("delete/multiple", views.delete_scans, name="delete_multiple_scans"),
]
