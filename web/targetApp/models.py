...
class DomainInfo(models.Model):
    ...
    registrar = models.ForeignKey(
        DomainRegistrar, blank=True, on_delete=models.CASCADE, null=True
    )
    ...
    # registrant
    registrant_name = models.ForeignKey(
        DomainRegisterName,
        blank=True,
    ...
    registrant_organization = models.ForeignKey(
        DomainRegisterOrganization,
        blank=True,
        on_delete=models.CASCADE,
        related_name="registrant_organization",
        null=True,
    )
    registrant_address = models.ForeignKey(
        DomainAddress,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_city = models.ForeignKey(
        DomainCity,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_state = models.ForeignKey(
        DomainState,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_zip_code = models.ForeignKey(
        DomainZipCode,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_country = models.ForeignKey(
        DomainCountry,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_email = models.ForeignKey(
        DomainEmail,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_phone = models.ForeignKey(
        DomainPhone,
        blank=True,
        on_delete=models.CASCADE,
    ...
    registrant_fax = models.ForeignKey(
        DomainFax,
        blank=True,
        on_delete=models.CASCADE,
    ...
    admin_zip_code = models.ForeignKey(
        DomainZipCode,
        blank=True,
        on_delete=models.CASCADE,
    ...
    admin_country = models.ForeignKey(
        DomainCountry,
        blank=True,
        on_delete=models.CASCADE,
    ...
    tech_organization = models.ForeignKey(
        DomainRegisterOrganization,
        blank=True,
        on_delete=models.CASCADE,
    ...
    tech_address = models.ForeignKey(
        DomainAddress,
        blank=True,
        on_delete=models.CASCADE,
    ...
    tech_zip_code = models.ForeignKey(
        DomainZipCode,
        blank=True,
        on_delete=models.CASCADE,
    ...
    tech_country = models.ForeignKey(
        DomainCountry,
        blank=True,
        on_delete=models.CASCADE,
